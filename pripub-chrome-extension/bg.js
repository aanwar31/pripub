chrome.browserAction.onClicked.addListener(function(tab) {
    ...
    tablink = tablink.replace("https://", "");
    
    tablinkMD5 = MD5(tablink);

    chrome.windows.create({ 
        url: 'http://pripub.com/'+tablinkMD5+"[-*_pp_*-]"+tablink, 
        type: 'popup',
...
chrome.tabs.onActivated.addListener(function(evt){ 
    chrome.tabs.get(evt.tabId, function(tab){ 
        ...
        if(tablink === "chrome://newtab/"){
            ...
            if(tablink.length === 33 && tablink.substr(-1) === 'p'){
                tablink= tablink.substr(0, tablink.length - 1);
                tablink = (tablink);
            } else {
                 tablink = MD5(tablink);
            }
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4) {
                    ...
                    var jonline = eval(jsonData.online*1); 
